...
import { listDbInvoiceDeliveryNoteCandidates } from "@/lib/kagu/document-repository";
...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json({
      items: await listDbInvoiceDeliveryNoteCandidates({
    ...
    return jsonBadRequest(error, "Invoice delivery candidates failed");
  }
}
