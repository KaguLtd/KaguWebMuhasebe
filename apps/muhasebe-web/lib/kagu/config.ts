...
export const masterModules: MasterModuleConfig[] = [
  {
    ...
    columns: [
      ...
      { key: "account_kind", title: "Tip" },
      { key: "currency", title: "Doviz Kuru" },
    ...
    fields: [
      ...
      { name: "currency", label: "Doviz Kuru", type: "select", required: true, options: currencyOptions },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "default_vat_rate_bps", title: "KDV" },
      { key: "is_active", title: "Durum" },
      { key: "total_stock", title: "Toplam Stok" },
    ],
    fields: [
      { name: "code", label: "Kod", type: "text", required: true },
...
export const documentModules: DocumentModuleConfig[] = [
  {
    ...
    columns: [
      ...
      { key: "actual_doc_no", title: "Gercek Evrak No" },
      { key: "merge_role", title: "Tip" },
      { key: "is_return", title: "Iade" },
      { key: "direction", title: "Yon" },
      { key: "doc_date", title: "Tarih" },
      { key: "status", title: "Durum" },
    ],
    headerFields: [
      { name: "direction", label: "Yon", type: "select", required: true, options: directionOptions },
      { name: "isReturn", label: "Iade", type: "switch" },
      { name: "actualDocNo", label: "Gercek Evrak No", type: "text", required: true },
      { name: "accountId", label: "Cari", type: "select", required: true, lookupEntity: "accounts" },
    ...
    lineFields: [
      ...
      { name: "description", label: "Aciklama", type: "text" },
      ...
      { name: "currency", label: "Doviz Kuru", type: "select", options: currencyOptions },
  ...
  },
  {
    ...
    columns: [
      { key: "account_id", title: "Cari" },
      { key: "doc_no", title: "Evrak No" },
      { key: "invoice_type", title: "Tip" },
      { key: "actual_doc_no", title: "Gercek Evrak No" },
      { key: "currency", title: "Doviz Kuru" },
      { key: "doc_date", title: "Tarih" },
      { key: "document_total_minor", title: "Bedel" },
      { key: "status", title: "Durum" },
    ],
    headerFields: [
      { name: "accountId", label: "Cari", type: "select", required: true, lookupEntity: "accounts" },
      { name: "projectId", label: "Proje", type: "select", lookupEntity: "projects" },
      { name: "invoiceKind", label: "Tur", type: "select", required: true, options: invoiceKindOptions },
      { name: "invoiceType", label: "Tip", type: "select", required: true, options: invoiceTypeOptions },
      { name: "actualDocNo", label: "Gercek Evrak No", type: "text" },
      { name: "warehouseId", label: "Depo", type: "select", required: true, lookupEntity: "warehouses" },
      { name: "docDate", label: "Tarih", type: "date", required: true },
      { name: "discountBps", label: "Iskonto", type: "number", min: 0, step: 1 },
      { name: "currency", label: "Doviz Kuru", type: "select", required: true, options: currencyOptions },
      { name: "description", label: "Aciklama", type: "textarea" },
    ],
    lineFields: [
  ...
  },
  {
    ...
    headerFields: [
      { name: "receiptKind", label: "Tip", type: "select", required: true, options: receiptKindOptions },
      { name: "accountId", label: "Cari", type: "select", required: true, lookupEntity: "accounts" },
      { name: "projectId", label: "Proje", type: "select", lookupEntity: "projects" },
      { name: "docDate", label: "Tarih", type: "date", required: true },
